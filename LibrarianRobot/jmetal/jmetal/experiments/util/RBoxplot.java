...
public class RBoxplot {
  ...
  public static  void generateScripts(int rows,
    ...
    for (String element : experiment.indicatorList_) {
      ...
      String rFile =  rDirectory + "/" + prefix + "." +  element + ".Boxplot.R";
      ...
      for (String element2 : experiment.algorithmNameList_) {
        os.write("file" +  element2 +
        ...
        os.write("file" +  element2 +
                "<-paste(file" +  element2 + ", " +
                "indicator, sep=\"/\")" + "\n");
        os.write( element2 + "<-scan(" + "file" +  element2 + ")" + "\n");
        os.write("\n");
      } // for
