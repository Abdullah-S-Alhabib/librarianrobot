...
public class RWilcoxon {
  ...
  public static void generateScripts(
    ...
    for (String element : experiment.indicatorList_) {
      System.out.println("Indicator: " + element);
      String rFile = rDirectory + "/" + prefix + "." + element + ".Wilcox.R";
      String texFile = rDirectory + "/" + prefix + "." + element + ".Wilcox.tex";
      ...
      latexTableCaption = "  write(\"\\\\caption{\", \"" + texFile + "\", append=TRUE)" + "\n" +
              ...
              "  write(\"." + element + ".}\", \"" + texFile + "\", append=TRUE)" + "\n";
      ...
      if (experiment.indicatorMinimize_.get(element)) {// minimize by default
