...
public void evaluate(Solution solution) throws JMException {
    ...
    solution.setObjective(0, 0.5*(yj + 2*x[0])*x[1]		+ 2.0*sum1 / count1);
    solution.setObjective(1, 0.5*(yj - 2*x[0] + 2.0)*x[1] + 2.0*sum2 / count2);
    solution.setObjective(2, 1.0 - x[1]                   + 2.0*sum3 / count3) ;
  } // evaluate
} // CEC2009_UF9
