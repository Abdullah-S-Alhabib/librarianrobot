...
public String toString() {
  ...
  public int getNumberOfBits() {
    ...
    for (Variable element : variable_)
		if ((element.getVariableType() == jmetal.encodings.variable.Binary.class) ||
		      (element.getVariableType() == jmetal.encodings.variable.BinaryReal.class))
