 ...
 * </p>
 * <ul>
 *   <li>{@link sa.edu.cs.librarianrobot.modeling.librarypackage.impl.BookImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link sa.edu.cs.librarianrobot.modeling.librarypackage.impl.BookImpl#getAuthors <em>Authors</em>}</li>
 *   <li>{@link sa.edu.cs.librarianrobot.modeling.librarypackage.impl.BookImpl#getXCoordinate <em>XCoordinate</em>}</li>
 *   <li>{@link sa.edu.cs.librarianrobot.modeling.librarypackage.impl.BookImpl#getYCoordinate <em>YCoordinate</em>}</li>
 *   <li>{@link sa.edu.cs.librarianrobot.modeling.librarypackage.impl.BookImpl#getWeight <em>Weight</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BookImpl extends PublicationImpl implements Book {
	...
	protected EClass eStaticClass() {
		return LibrarypackagePackage.Literals.BOOK;
	}
...
//			eNotify(new ENotificationImpl(this, Notification.set, LibrarypackagePackage.BOOK__TITLE, oldTitle, title));
	}
	...
	public void setAuthors(String newAuthors) {
		...
		authors = newAuthors;
//		if (eNotificationRequired())
//			eNotify(new ENotificationImpl(this, Notification.SET, LibrarypackagePackage.BOOK__AUTHORS, oldAuthors, authors));
	}
...
//		if (eNotificationRequired())
//			eNotify(new ENotificationImpl(this, Notification.SET, LibrarypackagePackage.BOOK__XCOORDINATE, oldXCoordinate, xCoordinate));
	}
...
//		if (eNotificationRequired())
//			eNotify(new ENotificationImpl(this, Notification.SET, LibrarypackagePackage.BOOK__YCOORDINATE, oldYCoordinate, yCoordinate));
	}
	...
	public void setWeight(int newWeight) {
		...
		weight = newWeight;
//		if (eNotificationRequired())
//			eNotify(new ENotificationImpl(this, Notification.SET, LibrarypackagePackage.BOOK__WEIGHT, oldWeight, weight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case LibrarypackagePackage.BOOK__TITLE:
				return getTitle();
			case LibrarypackagePackage.BOOK__AUTHORS:
				return getAuthors();
			case LibrarypackagePackage.BOOK__XCOORDINATE:
				return getXCoordinate();
			case LibrarypackagePackage.BOOK__YCOORDINATE:
				return getYCoordinate();
			case LibrarypackagePackage.BOOK__WEIGHT:
				return getWeight();
		}
