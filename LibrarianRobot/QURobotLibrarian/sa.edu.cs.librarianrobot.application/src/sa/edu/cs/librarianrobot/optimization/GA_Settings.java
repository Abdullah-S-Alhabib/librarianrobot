...
public class GA_Settings extends Settings{
	 ...
	 * Constructor
	 */
	public GA_Settings(String problemName, Problem problem, int popSize, int maxEval) {
		 super(problemName) ;
		 problem_ = problem;
		 
		 // Attributes holding algorithm settings.
		...
		public Algorithm configure() throws JMException {
		    ...
		    // Mutation and Crossover operators fit for Permutation codification
